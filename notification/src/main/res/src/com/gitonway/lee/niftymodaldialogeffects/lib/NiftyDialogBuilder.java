package src.com.gitonway.lee.niftymodaldialogeffects.lib;
...
public class NiftyDialogBuilder extends Dialog implements DialogInterface {
    ...
    public NiftyDialogBuilder withDialogColor(String colorString) {
        mLinearLayoutView.getBackground().setColorFilter(com.gitonway.lee.niftymodaldialogeffects.lib.ColorUtils.getColorFilter(Color.parseColor(colorString)));
        return this;
    }
    ...
    public NiftyDialogBuilder withEffect(com.gitonway.lee.niftymodaldialogeffects.lib.Effectstype type) {
        this.type=type;
        return this;
    }
